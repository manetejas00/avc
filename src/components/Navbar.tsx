...
const navItems = [['Home', '/'], ['Screener', '/screener'], ['Services', '/#services'], ['Markets', '/#markets'], ['Mutual Funds', '/#mutual-funds'], ['Calculators', '/#calculators'], ['News', '/#news'], ['FAQ', '/#faq']] as const;
